...
def get_datasets(args):
    classes = load_classes(os.path.join('/Users/andrea.sanchez/Desktop/mcv-c6-2025-team3/W6/CVMasterActionSpotting/data', args.dataset, 'class.txt'))
    ...
    train_data = ActionSpotDataset(
        classes, os.path.join('/Users/andrea.sanchez/Desktop/mcv-c6-2025-team3/W6/CVMasterActionSpotting/data', args.dataset, 'train.json'),
        args.frame_dir, args.store_dir, args.store_mode, args.clip_len, dataset_len, **dataset_kwargs)
    train_data.print_info()

    val_data = ActionSpotDataset(
        classes, os.path.join('/Users/andrea.sanchez/Desktop/mcv-c6-2025-team3/W6/CVMasterActionSpotting/data', args.dataset, 'val.json'),
        args.frame_dir, args.store_dir, args.store_mode, args.clip_len, dataset_len // 4, **dataset_kwargs)
    val_data.print_info()     

    dataset_kwargs['overlap'] = 0

    test_data = ActionSpotVideoDataset(classes, os.path.join('/Users/andrea.sanchez/Desktop/mcv-c6-2025-team3/W6/CVMasterActionSpotting/data', args.dataset, 'test.json'),
