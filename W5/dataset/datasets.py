...
def get_datasets(args):
    classes = load_classes(os.path.join('/home/danielpardo/c6/W5/data/', args.dataset, 'class.txt'))
    ...
    train_data = ActionSpotDataset(
        classes, os.path.join('/home/danielpardo/c6/W5/data/', args.dataset, 'train.json'),
        args.frame_dir, args.store_dir, args.store_mode, args.clip_len, dataset_len, **dataset_kwargs)
    train_data.print_info()

    val_data = ActionSpotDataset(
        classes, os.path.join('/home/danielpardo/c6/W5/data/', args.dataset, 'val.json'),
    ...
    test_data = ActionSpotDataset(
        classes, os.path.join('/home/danielpardo/c6/W5/data/', args.dataset, 'test.json'),
